...
const UpdateToolModal = ({ open, setOpen, tool }: { open: boolean, setOpen: any, tool: Tool }) => {
    ...
    //////////////////////////////////////////// STATES ///////////////////////////////////////////////
    const [toolData, setToolData] = useState<Tool>(tool)

    //////////////////////////////////////////// USE EFFECTS ///////////////////////////////////////////////
    useEffect(() => {
        open && setToolData(tool)
    }, [tool, open])
    useEffect(() => {
    ...
    const handleSubmit = () => {
        ...
        dispatch<any>(updateTool(tool._id, toolData))
        setOpen(false)
    }
            ...
            <div className='bg-white flex flex-col gap-[1.5rem] md:w-[70vw] sm:w-[80vw] w-[95vw] max-h-[80vh] overflow-y-scroll rounded-lg md:p-8 sm:p-6 p-4  ' >
                ...
                <div className="flex flex-col gap-[1rem] ">
                    ...
                    <div className="flex justify-between items-center">
                        <h1 className='text-main-blue font-bold text-[36px] ' >Update Tool</h1>
                    </div>

                    {/* speciality and subcategory */}
                    <div className="flex justify-between gap-[1rem] ">
                        <select value={toolData.category} onChange={(e) => handleChange('category', e.target.value)} className="w-[48%] bg-gray-50 border border-light-gray text-gray-900 text-sm rounded-full focus:ring-light-gray focus:border-light-gray outline-none block py-3 px-6 dark:focus:ring-blue-500">
                        ...
                        <select value={toolData.subcategory} onChange={(e) => handleChange('subcategory', e.target.value)} className="w-[48%] bg-gray-50 border border-light-gray text-gray-900 text-sm rounded-full focus:ring-light-gray focus:border-light-gray outline-none block py-3 px-6 dark:focus:ring-blue-500">
                ...
                <div className="flex flex-col gap-[1rem] ">
                    ...
                    <div className="flex flex-col gap-[1rem] ">
                        ...
                        <div className="">
                            ...
                            <Switch checked={toolData.languageDropdown == 'true' ? true : false} onChange={(e) => handleChange('languageDropdown', e.target.checked ? 'true' : 'false')} />
                            <span>Show</span>
                        </div>
                    </div>
                    {/* save button */}
